...
type AuthClient interface {
	...
	IsAdmin(ctx context.Context, in *IsAdminRequest, opts ...grpc.CallOption) (*LoginResponse, error)
}
...
func (c *authClient) IsAdmin(ctx context.Context, in *IsAdminRequest, opts ...grpc.CallOption) (*LoginResponse, error) {
	out := new(LoginResponse)
...
type AuthServer interface {
	...
	IsAdmin(context.Context, *IsAdminRequest) (*LoginResponse, error)
...
func (UnimplementedAuthServer) IsAdmin(context.Context, *IsAdminRequest) (*LoginResponse, error) {
